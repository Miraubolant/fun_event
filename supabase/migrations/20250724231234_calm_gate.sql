/*
  ...
  2. Insertion des structures
  3. Insertion des photos de carrousel
*/

-- Insert categories
INSERT INTO categories (id, label, icon) VALUES
  ('gonflable', 'Location gonflable', '🎪'),
...
INSERT INTO structures (id, name, category_id, size, capacity, age, price, price_2_days, max_weight, services, image, description, available) VALUES
  ('1', 'Instables Gladiateurs', 'gonflable', '7,7m x 6,6m x 1,5m', '2 personnes max', '3-77 ans', 180, NULL, 100, 'Livraison 7 jours / 7 jours, Enrouleurs électrique inclus, Structures nettoyées entre chaque location', 'https://i.imgur.com/fLqAlJ1.png', 'Entrez dans l''arène et relevez le défi des gladiateurs ! ⚔🔥
...
📅 Réservez dès maintenant pour un maximum de fun et de défis ! 🎉🔥', true),
  ...
  ('2', 'Château Cirque', 'gonflable', '3,8m x 2,8m x 2,8m', '12 personnes max', '3-77 ans', 150, NULL, 70, 'Conforme EN 14960, Livraison 7 jours / 7 jours, Enrouleurs électrique inclus, Structures nettoyées entre chaque location', 'https://i.imgur.com/XcGSPl6.png', '🤹 Toute la Magie du Cirque dans un Château Gonflable ! 🎪
...
📅 Ajoutez une touche de magie à votre événement, réservez dès maintenant !', true),
  ...
  ('3', 'Multiplay Jurassic World', 'gonflable', '5m x 5,5m x 4,30m', '12 personnes max', '3-77 ans', 200, NULL, 160, 'Conforme EN 14960, Livraison 7 jours / 7 jours, Enrouleurs électrique inclus, Structures nettoyées entre chaque location', 'https://i.imgur.com/dyYum3x.png', 'Partez à l''aventure avec la structure gonflable Multiplay Jurassic World
...
N''attendez plus, rendez chaque événement encore plus magique avec cette attraction hors du commun et faites vivre à vos invités un moment d''évasion inoubliable !', true),
  ...
  ('4', 'Le Monde Marin', 'gonflable', '3,8m x 9,5m x 5,80m', '8 personnes max', '3-77 ans', 180, NULL, 210, 'Conforme EN 14960, Livraison 7 jours / 7 jours, Enrouleurs électrique inclus, Structures nettoyées entre chaque location', 'https://i.imgur.com/bnFv4OP.png', 'Un parcours d''obstacles marin pour des événements inoubliables !
...
Idéale pour tous types d''événements, que ce soit des anniversaires, des fêtes d''école ou des animations en extérieur, le parcours Monde Marin garantit de nombreux sourires et des heures de divertissement. Faites de chaque fête un moment unique avec cette structure gonflable pleine de surprises !', true),
  ...
  ('5', 'Sumo adulte', 'gonflable', 'Tapis : 25m²', '2 personnes max', '3-77 ans', 120, NULL, 100, 'Livraison 7 jours / 7 jours, Enrouleurs électrique inclus, Structures nettoyées entre chaque location', 'https://i.imgur.com/IiQCoo8.png', '👊 Combat de Sumos – Fous rires garantis ! 🤩
...
📅 Réservez dès maintenant et mettez du fun dans votre événement !', true),
  ...
  ('6', 'Machine à coup de poing', 'gonflable', '1,2m x 0,7m x 2,1m', '1 personne max', '3-77 ans', 80, NULL, 145, 'Conforme EN 14960, Livraison 7 jours / 7 jours, Enrouleurs électrique inclus, Structures nettoyées entre chaque location', 'https://i.imgur.com/pT0UHhG.png', 'Prêt à relever le défi de la machine à coup de poing ?
...
Alors, qui frappera le plus fort cette fois ?', true),
  ...
  ('7', 'Pêche aux canards', 'gonflable', '1,5m x 3,4m x 1,3m', '12 personnes max', '3-77 ans', 60, NULL, 30, 'Conforme EN 14960, Livraison 7 jours / 7 jours, Enrouleurs électrique inclus, Structures nettoyées entre chaque location', 'https://i.imgur.com/o750EVP.png', 'La pêche aux canards : un grand classique qui fait toujours plaisir !
...
Le circuit fonctionne avec de l''eau, pour une animation encore plus réaliste', true),
  ...
  ('8', 'Piscine à balles', 'gonflable', '4,4m x 3,5m x 2,4m', '12 personnes max', '3-77 ans', 90, NULL, 70, 'Livraison 7 jours / 7 jours, Enrouleurs électrique inclus, Structures nettoyées entre chaque location', 'https://i.imgur.com/bWxOi76.png', 'Un rêve d''enfant devenu réalité !
...
Parfaite en intérieur comme en extérieur, cette activité ludique promet des moments inoubliables, remplis de rires et de couleurs.', true),
  ...
  ('9', 'Sumo enfant', 'gonflable', 'Tapis : 25m²', '2 personnes max', '3-77 ans', 100, NULL, 100, 'Livraison 7 jours / 7 jours, Enrouleurs électrique inclus, Structures nettoyées entre chaque location', 'https://i.imgur.com/0XCSWRh.png', '👊 Combat de Sumos – Fous rires garantis ! 🤩
...
📅 Réservez dès maintenant et mettez du fun dans votre événement !', true),
  ...
  ('10', 'Machine à Barbe à Papa', 'gourmandises', 'Machine professionnelle', 'Illimité', 'Tous âges', 50, NULL, NULL, 'Livraison 7 jours / 7 jours, Machine nettoyée entre chaque location', 'https://i.imgur.com/CNVQPx9.png', 'Plongez en enfance et régalez vos invités avec notre machine à barbe à papa professionnelle ! En quelques instants, créez de délicieuses barbes à papa qui émerveilleront petits et grands.', true),
  
  ('11', 'Machine à pop-corn', 'gourmandises', 'Machine professionnelle', 'Illimité', 'Tous âges', 50, NULL, NULL, 'Livraison 7 jours / 7 jours, Machine nettoyée entre chaque location', 'https://i.imgur.com/noA5nmd.png', 'Offrez aux enfants un moment de purement magique et fun avec notre château gonflable sur le thème du cirque !', true),
  
  ('12', 'Machine à gaufres', 'gourmandises', 'Machine professionnelle', 'Illimité', 'Tous âges', 60, NULL, NULL, 'Livraison 7 jours / 7 jours, Machine nettoyée entre chaque location', 'https://i.imgur.com/fHdP8HH.png', 'Offrez à vos invités une expérience inoubliable en les plongeant au cœur de l''ère préhistorique avec la structure gonflable Multiplay Jurassic World.', true),
  
  ('13', 'Machine à crêpes', 'gourmandises', 'Machine professionnelle', 'Illimité', 'Tous âges', 60, NULL, NULL, 'Livraison 7 jours / 7 jours, Machine nettoyée entre chaque location', 'https://i.imgur.com/SM4tkzP.png', 'Offrez à vos petits aventuriers un voyage sous-marin rempli de fun et de défis avec notre parcours gonflable Monde Marin de 9 mètres de long !', true),
  
  ('14', 'Magicien', 'evenementiel', 'Prestation sur mesure', 'Jusqu''à 50 personnes', 'Tous âges', 0, NULL, NULL, 'Prestation personnalisée, Matériel inclus, Déplacement en Île-de-France', 'https://i.imgur.com/kTXIuZD.png', 'Émerveillez vos invités avec un spectacle de magie professionnel ! Notre magicien expérimenté propose des tours adaptés à tous les âges, des illusions fascinantes aux numéros interactifs. Parfait pour anniversaires, événements d''entreprise et fêtes familiales.', true),
  
  ('15', 'Sculpteur de ballons', 'evenementiel', 'Animation mobile', 'Jusqu''à 30 enfants/heure', '3-12 ans', 0, NULL, NULL, 'Ballons fournis, Animation personnalisée, Créations à emporter', 'https://imgur.com/sTAtBdS.png', 'Transformez des ballons en œuvres d''art ! Notre sculpteur professionnel crée en direct des animaux, fleurs et personnages qui raviront les enfants. Chaque création devient un souvenir unique de votre événement.', true),
  
  ('16', 'Maquilleuse', 'evenementiel', 'Poste de maquillage', '15-20 enfants/heure', '3-12 ans', 0, NULL, NULL, 'Maquillage hypoallergénique, Matériel professionnel, Designs variés', 'https://i.imgur.com/k59vJoX.png', 'Transformez les enfants en leurs héros préférés ! Notre maquilleuse professionnelle utilise des produits sûrs et hypoallergéniques pour créer des maquillages fantastiques : animaux, super-héros, princesses et bien plus encore.', true),
  
  ('17', 'Mascotte', 'evenementiel', 'Animation interactive', 'Tous publics', 'Tous âges', 0, NULL, NULL, 'Costume professionnel, Animation personnalisée, Photos souvenirs', 'https://i.imgur.com/Rq9gyt0.png', 'Donnez vie à votre événement avec nos mascottes colorées ! Nos animateurs professionnels en costume créent une ambiance festive inoubliable avec danses, jeux et interactions qui raviront petits et grands.', true)
ON CONFLICT (id) DO NOTHING;

-- Insert carousel photos
INSERT INTO carousel_photos (id, url, alt, title, location, order_position) VALUES
  ('1', 'https://i.imgur.com/kA2Secn.png', 'Structure gonflable 1', 'Anniversaire Magique', 'Paris 15ème', 1),
  ('2', 'https://i.imgur.com/yj3D8xk.png', 'Structure gonflable 2', 'Fête d''École', 'Boulogne-Billancourt', 2),
  ('3', 'https://i.imgur.com/eJrSzxS.png', 'Structure gonflable 3', 'Kermesse Paroissiale', 'Versailles', 3),
  ('4', 'https://i.imgur.com/PpYERbM.png', 'Structure gonflable 4', 'Team Building', 'La Défense', 4),
  ('5', 'https://i.imgur.com/AdHVFs4.png', 'Structure gonflable 5', 'Mariage Champêtre', 'Fontainebleau', 5),
  ('6', 'https://i.imgur.com/6qMhuOF.png', 'Structure gonflable 6', 'Fête de Quartier', 'Créteil', 6)
ON CONFLICT (id) DO NOTHING;